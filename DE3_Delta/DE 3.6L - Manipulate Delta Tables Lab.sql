...
-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("dbfs:/mnt/dbacademy-users/elisabeth.fauquet@openvalue.fr/data-engineering-with-databricks/database.db/beans/_delta_log"))
...
SELECT grams FROM beans VERSION AS OF 5
